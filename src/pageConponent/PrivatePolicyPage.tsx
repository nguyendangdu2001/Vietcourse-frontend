...
export const PrivatePolicyPage = () => {
    return (
        <div>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        Agreement) refers to Vietcourse.
                    </p>
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to Vietcourse, accessible from https://vietcourse.herokuapp.com
                </li>{" "}
                <li>
            ...
            <ul>
                <li>By email: nguyendangdu2001@gmail.com</li>
            </ul>
        </div>
    );
};
